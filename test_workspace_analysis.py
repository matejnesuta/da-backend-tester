...
WORKSPACE_FIXTURES = {
    "npm_workspace": {
        "root": Path("testfiles/npm/npm_workspace"),
        "expected_packages": 3,  # root + 2 members
        "ecosystem": "npm",
    },
    "npm_workspace_with_invalid": {
        "root": Path("testfiles/npm/npm_workspace_with_invalid"),
        "expected_packages": 1,  # only valid package-a (invalid package should be skipped)
        "ecosystem": "npm",
    },
    "pnpm_workspace": {
        "root": Path("testfiles/pnpm/pnpm_workspace"),
        "expected_packages": 3,  # root + 2 members
        "ecosystem": "pnpm",
    },
    "npm_workspace_member": {
        "member_manifest": Path("testfiles/npm/npm_workspace_member/packages/package-a/package.json"),
        "ecosystem": "npm",
    },
}
